...
KMS_DATA_KEY_ID = os.environ.get('KMS_DATA_KEY_ID', '')  # Optional: set in Week 8
...
def handle_post_photos(event, sub, groups):
    ...
    if KMS_DATA_KEY_ID:
        ...
        put_params['SSEKMSKeyId'] = KMS_DATA_KEY_ID
    ...
    return response(200, {
        ...
        's3Key':     s3_key,
        'encryption': 'aws:kms' if KMS_DATA_KEY_ID else 'none',
        'kmsKeyId':  KMS_DATA_KEY_ID or None
    })
